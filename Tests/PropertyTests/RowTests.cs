...
namespace WForest.Tests.PropertyTests
{
    ...
    public class RowPropertyTests
    {
        ...
        public void ApplyOn_WidgetsPassHorizontalLimit_GoOnNewRow()
        {
            var acts = new[]
            {
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 640, 120))),
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 320, 120))),
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 160, 120))),
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 80, 120))),
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 128, 64))),
            };
        ...
        public void ApplyOn_WidgetsWithDifferentHeights_RowGetsMaxHeight()
        {
            ...
            {
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 640, 120))),
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 600, 320))),
                _root.AddChild(Widgets.Container(new Rectangle(0, 0, 128, 64))),
            };
