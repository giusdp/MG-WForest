...
namespace WForest.UI
{
    public class HUD
    {
        ...
        public HUD()
        {
            ...
            var column = _root.AddChild(Factories.Widgets.Container(120, 630));
            column.AddProperty(Factories.Properties.Column());
            
            column.AddChild(Factories.Widgets.ImageButton("SpriteBtnA"));
            ...
            // cont.AddProperty(Factories.Properties.Border(Color.Chocolate,1));
